...
class PhpExcelHelper extends AppHelper {
	...
	public function addTableColumn($offset,$value) {
		$this->xls->getActiveSheet()->setCellValueByColumnAndRow($offset,$this->row,$value);
		$this->row++;
		$this->tableParams['row_count']++;
	}
	/**
	...
	public function makeDropDown($cell) {
		$this->xls->setActiveSheetIndex(0);
	    $objValidation = $this->xls->getActiveSheet()->getCell($cell)->getDataValidation();
	    $objValidation->setFormula1('ListsSheet!$R$2:$R$240');
