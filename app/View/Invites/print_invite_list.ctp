<div class="panel panel-primary">
	<div class="panel-heading">
		...
		<div class="pull-right">
			<a class="glyphicon glyphicon-print f20 mt5 mr5" href="javascript:;" onclick="printElem();"></a>
			...
			<div class="col-lg-4">
				<ul class="list-group">
					<li class="list-group-item pl0 pr5">
						...
						<div class="col-lg-8"><strong><?php echo $contact['Contact']['mobile']; ?></strong></div>
						<div class="clearfix"></div>
...
echo $this->Html->script(array('jQBrowser','jquery.printElement.min'),array('block' => 'bottomScript'));

$script = 'printElem = function(){
