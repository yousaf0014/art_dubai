...
?>
    ...
    <h1 title="Usuário"><?php echo $user[$user_model_name][$user_display_field]; ?></h1>
    <hr>

    <h2 class="pull-left"><?php echo __d('acl', 'Role'); ?></h2>
    ...
    <div class="col-lg-7">
    	...
    	<tr>
        	...
        	$headers = array(__d('acl', 'authorization'), __d('acl', 'action'));
